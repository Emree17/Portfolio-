            ...
            <a href='#top' className='logo'>
                ...
                <li> <a className="ind" href="#about-page"> About Me </a> </li>
                    ...
                    <button className="resume" target="_blank" rel="noopener noreferrer">
                      <li> <a className="res" href="https://drive.google.com/file/d/1tFrtcra8zvYELgKbPVefx_vun7WITgdR/view?usp=sharing" target="_blank" rel="noopener noreferrer"> Resume</a> </li>
                    </button>
                    </Fade>            
                </ul>
        </header>
